 ...
 */
export interface DialogMessageEvent extends TableauEvent {
    /**
     * @returns the message that was sent to/from the dialog.
     */
    readonly message: string;
    /**
     * @returns the url of the dialog that sent the message.
     * If undefined, the message was sent by the host extension itself.
     */
    readonly sourceDialogUrl?: string;
}
/**
